...
<a href="https://pkg.go.dev/github.com/stainless-sdks/carbonaware-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/carbonaware-go.svg" alt="Go Reference"></a>
...
```go
import (
	"github.com/stainless-sdks/carbonaware-go" // imported as carbonaware
)
```
...
```sh
go get -u 'github.com/stainless-sdks/carbonaware-go@v0.0.1-alpha.0'
```
...
```go
p := carbonaware.ExampleParams{
	ID:   "id_xxx",                  // required property
	Name: carbonaware.String("..."), // optional property

	Point: carbonaware.Point{
		X: 0,                  // required field will serialize as 0
		Y: carbonaware.Int(1), // optional field will serialize as 1
		// ... omitted non-required fields will not be serialized
	},

	Origin: carbonaware.Origin{}, // the zero value of [Origin] is considered omitted
}
```
...
custom := param.Override[carbonaware.FooParams](12)
```
...
client.Schedule.New(context.TODO(), ...,
	// Override the header
...
See the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/carbonaware-go/option).
...
`*carbonaware.Error`. This contains the `StatusCode`, `*http.Request`, and
...
if err != nil {
	...
	panic(err.Error()) // GET "/v0/schedule/": 400 Bad Request { ... }
}
```
...
We also provide a helper `carbonaware.File(reader io.Reader, filename string, contentType string)`
...
schedule, err := client.Schedule.New(
	context.TODO(),
	carbonaware.ScheduleNewParams{
		Duration: "PT1H",
		Windows: []carbonaware.ScheduleNewParamsWindow{{
...
params := FooNewParams{
    ...
    Data: FooNewParamsData{
        FirstName: carbonaware.String("John"),
    },
}
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/carbonaware-go/issues) with questions, bugs, or suggestions.
