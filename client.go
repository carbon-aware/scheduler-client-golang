...
// interacting with the carbonaware-scheduler API. You should not instantiate this
...
// environment (CARBONAWARE_SCHEDULER_BASE_URL). The option passed in as arguments
