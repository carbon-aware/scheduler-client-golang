...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Schedule.New(context.Background(), carbonaware.ScheduleNewParams{
		Duration: "PT1H",
		Windows: []carbonaware.ScheduleNewParamsWindow{{
			End:   time.Now(),
			Start: time.Now(),
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Schedule.New(cancelCtx, carbonaware.ScheduleNewParams{
		Duration: "PT1H",
		Windows: []carbonaware.ScheduleNewParamsWindow{{
			End:   time.Now(),
			Start: time.Now(),
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Schedule.New(deadlineCtx, carbonaware.ScheduleNewParams{
			Duration: "PT1H",
			Windows: []carbonaware.ScheduleNewParamsWindow{{
				End:   time.Now(),
				Start: time.Now(),
