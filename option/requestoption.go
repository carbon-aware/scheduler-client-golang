...
// RequestOption is an option for the requests made by the carbonaware-scheduler API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/carbon-aware/scheduler-client-golang#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://scheduler.carbonaware.dev/")
}
